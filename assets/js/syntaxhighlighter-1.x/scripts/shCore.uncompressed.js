...
var dp = {
	sh :
	{
		...
		Brushes	: {},
		Strings : {
			AboutDialog : '<html><head><title>About...</title></head><body class="dp-about"><table cellspacing="0"><tr><td class="copy"><p class="title">dp.SyntaxHighlighter</div><div class="para">Version: {V}</p><p><a href="http://www.dreamprojections.com/syntaxhighlighter/?ref=about" target="_blank">http://www.dreamprojections.com/syntaxhighlighter</a></p>&copy;2004-2007 Alex Gorbatchev.</p><p>Modified by Evan Goer under GPL (scoped specifically for HTML).</p></td></tr><tr><td class="footer"><input type="button" class="close" value="OK" onClick="window.close()"/></td></tr></table></body></html>'
		},
		ClipboardSwf : null,
		Version : '1.5'
	}
...
dp.sh.Toolbar.Commands = {
	...
	// opens a new window and puts the resulting HTML inside.
	ViewHTML: {
		label: 'view html',
		func: function(sender, highlighter)
		{
			var code = highlighter.originalCode.replace(/\&lt;/g, '<').replace(/\&gt;/g, '>');
			var wnd = window.open('', '_blank', 'width=750, height=400, location=0, resizable=1, menubar=0, scrollbars=0');
			wnd.document.write('<html><body>' + code + '</body></html>');
			wnd.document.close();
		}
	},
...
/*  Commenting out; doesn't seem to work in Mac OS X 
